    ...
    <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-[420px] text-gray-900">
      ...
      <form className="flex flex-col gap-3">
        <input
          ...
          name="name"
          placeholder="Navn"
          className="border border-gray-300 rounded-md px-4 py-3 text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#4C80C2]"
        />
        ...
        <select
          name="service"
          defaultValue=""
          className="border border-gray-300 rounded-md px-4 py-3 text-sm text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#4C80C2]"
        >
